...
namespace TeddyAttack
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()  //Default constructor
        {
        ...
        protected override void LoadContent()
        {
            ...
            teddyBearProjectileSprite = Content.Load<Texture2D>("teddyProjectile");
            explosionSpriteStrip = Content.Load<Texture2D>("explosion");

            // add initial game objects
            // add a burger object 7/8 of the window height down from the top
            burger = new Burger(
                Content,
                "burger",
                GameConstants.WINDOW_WIDTH / 2,
                GameConstants.WINDOW_HEIGHT * 7 / 8,
                null
            );
            SpawnBear();
